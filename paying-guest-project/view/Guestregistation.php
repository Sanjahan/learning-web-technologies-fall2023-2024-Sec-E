...
<body>
    <form action="../controller/signupcheckGuest.php" method="post">
    ...
    unset($_SESSION['phoneErr']);
         ...
         Gender:  <input type="radio" name="gender" value="male" <?php if(isset($gender)){if ($gender == 'male') echo 'checked';} ?> required>Male
                  <input type="radio" name="gender" value="female" <?php if(isset($gender)){if ($gender == 'female' ) echo 'female';} ?>>Female<br><br>
