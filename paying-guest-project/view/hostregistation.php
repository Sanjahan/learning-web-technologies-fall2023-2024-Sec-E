...
<body>
    <form action="../controller/signupcheckHost.php" method="post">
    ...
    unset($_SESSION['phoneErr']);
        ...
        Username:  <input type="text" name="username" id="Username" value="Ho-<?php if(isset($username)){echo $username;} ?>" required>
